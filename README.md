...
插件页面可查看每个群/私聊的绑定区服、机器人开关、JX3API Token、推栏标识，以及是否使用全局 Token；可查看认领人并取消其整个认领资格，也可按真实 ID 维护该群的授权管理员列表。Token、推栏标识在页面内完整展示，便于检查与修改。主动推送开关仍由命令管理，可发送 `通知管理` 查看。该页面仅供 AstrBot 后台主人使用，请勿暴露到公网。
